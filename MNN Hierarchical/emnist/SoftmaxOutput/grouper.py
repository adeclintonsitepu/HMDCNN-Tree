...
a = torch.load("emnist_root_softmax_output.pth", map_location=torch.device('cpu'))
...
a = torch.load('emnist_0_softmax_output.pth', map_location=torch.device('cpu'))
l = []
for i in range(12):
    l.append([i])
    for j in range(0,12):
...
a = torch.load('emnist_1_softmax_output.pth', map_location=torch.device('cpu'))
l = []
for i in range(4):
    l.append([i])
    for j in range(0,4):
...
a = torch.load('emnist_3_softmax_output.pth', map_location=torch.device('cpu'))
l = []
for i in range(13):
    l.append([i])
    for j in range(i,13):
...
a = torch.load('emnist_8_softmax_output.pth', map_location=torch.device('cpu'))
l = []
for i in range(4):
    l.append([i])
    for j in range(0,4):
